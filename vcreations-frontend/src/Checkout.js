    ...
    return (
      <div style={{textAlign:"center",padding:"40px 0",maxWidth:480,margin:"0 auto"}}>
        ...
        <div style={{background:"#f5faff",border:"2px solid var(--c-primary)",borderRadius:12,padding:24,marginBottom:24,textAlign:"left"}}>
          <h3 style={{color:"var(--c-primary)",marginBottom:16,fontSize:18,textAlign:"center"}}>💳 Pay Now — ₹{amount}</h3>

          <div style={{textAlign:"center",marginBottom:16}}>
            <img src={qrUrl} alt="UPI QR" style={{width:200,height:200,borderRadius:8}} />
          </div>

          <p style={{marginBottom:8,fontSize:13,color:"#555"}}>Or pay directly to UPI ID:</p>
          <div style={{fontSize:20,fontWeight:800,color:"#111",background:"white",padding:"10px 16px",borderRadius:8,border:"1px solid #ddd",marginBottom:16,textAlign:"center",letterSpacing:1}}>
            {config.upiId}
          </div>

          <a href={upiLink}
            className="btn"
            style={{display:"block",textAlign:"center",background:"var(--c-primary)",color:"white",fontWeight:700,fontSize:15,padding:"12px",borderRadius:8,textDecoration:"none",marginBottom:12}}>
            Pay with UPI App
          </a>
          ...
          <a href={waUrl} target="_blank" rel="noopener noreferrer"
            className="btn"
            style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8,background:"#25D366",color:"white",fontWeight:700,fontSize:15,padding:"12px 24px",borderRadius:8,textDecoration:"none"}}>
